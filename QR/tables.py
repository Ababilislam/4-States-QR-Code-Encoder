# -*- coding: utf-8 -*-
# thanks to Michael Nooner
#
#
"""This module lists out all of the tables needed to create a four states QR code.
If you are viewing this in the HTML documentation, I recommend reading the
actual file instead. The formatting for the tables is much more readable.
"""
...
# version size means N*N matrix size like if version 2 then its size is 25*25 matrix
...
#:
#: http://www.denso-wave.com/qrcode/vertable1-e.html
"""here i need to edit those mode value  0:152 is total data space
 after that indes repesent how many data a qr can hold. """
data_capacity = {                                                                       #hold the number of data a ver sion can contain.
    1: {
        # "L": {0: 152, 1: 41, 2: 25, 4: 17, 8: 10, },
        "L": {0: 304, 1: 82, 2: 50, 4: 34, 8: 20, },                                    #in here i  specified 34 to be 1st version capacity that can hold
        # "M": {0: 128, 1: 34, 2: 20, 4: 14, 8: 8, },
        "M": {0: 256, 1: 34, 2: 20, 4: 28, 8: 8, },
        # "Q": {0: 104, 1: 27, 2: 16, 4: 11, 8: 7, },
        "Q": {0: 104, 1: 27, 2: 16, 4: 22, 8: 7, },
        # "H": {0: 72, 1: 17, 2: 10, 4: 7, 8: 4, }
        "H": {0: 72, 1: 17, 2: 10, 4: 14, 8: 4, }
    },
    2: {
        # "L": {0: 272, 1: 77, 2: 47, 4: 32, 8: 20, },
        "L": {0: 544, 1: 77, 2: 47, 4: 64, 8: 20, },
        # "M": {0: 224, 1: 63, 2: 38, 4: 26, 8: 16, },
        "M": {0: 448, 1: 63, 2: 38, 4: 52, 8: 16, },
        "Q": {0: 352, 1: 48, 2: 29, 4: 40, 8: 12, },
        "H": {0: 256, 1: 34, 2: 20, 4: 28, 8: 8, }},
    3: {
        # "L": {0: 440, 1: 127, 2: 77, 4: 53, 8: 32, },
        # "M": {0: 352, 1: 101, 2: 61, 4: 42, 8: 26, },
        # "Q": {0: 272, 1: 77, 2: 47, 4: 32, 8: 20, },
        # "H": {0: 208, 1: 58, 2: 35, 4: 24, 8: 15, }
        "L": {0: 880, 1: 127, 2: 77, 4: 106, 8: 32, },
        "M": {0: 704, 1: 101, 2: 61, 4: 84, 8: 26, },
        "Q": {0: 544, 1: 77, 2: 47, 4: 64, 8: 20, },
        "H": {0: 416, 1: 58, 2: 35, 4: 48, 8: 15, }},
    4: {
        # "L": {0: 640, 1: 187, 2: 114, 4: 78, 8: 48, },
        # "M": {0: 512, 1: 149, 2: 90, 4: 62, 8: 38, },
        # "Q": {0: 384, 1: 111, 2: 67, 4: 46, 8: 28, },
        # "H": {0: 288, 1: 82, 2: 50, 4: 34, 8: 21, }},
        "L": {0: 1280, 1: 187, 2: 114, 4: 156, 8: 48, },
        "M": {0: 1024, 1: 149, 2: 90, 4: 124, 8: 38, },
        "Q": {0: 768, 1: 111, 2: 67, 4: 92, 8: 28, },
        "H": {0: 576, 1: 82, 2: 50, 4: 68, 8: 21, }},
    5: {
        # "L": {0: 864, 1: 255, 2: 154, 4: 106, 8: 65, },
        # "M": {0: 688, 1: 202, 2: 122, 4: 84, 8: 52, },
        # "Q": {0: 496, 1: 144, 2: 87, 4: 60, 8: 37, },
        # "H": {0: 368, 1: 106, 2: 64, 4: 44, 8: 27, }},
        "L": {0: 1728, 1: 255, 2: 154, 4: 212, 8: 65, },
        "M": {0: 1376, 1: 202, 2: 122, 4: 168, 8: 52, },
        "Q": {0: 992, 1: 144, 2: 87, 4: 120, 8: 37, },
        "H": {0: 736, 1: 106, 2: 64, 4: 88, 8: 27, }},
    6: {
...
eccwbi = {
    ...
    #     'Q': [13, 1, 13, 0, 0, ],
    #     'H': [17, 1, 9, 0, 0, ],
    # },                                                                        # i  need to make error code 14 block long.
    1: {
        'L': [13, 1, 38, 0, 0, ],
        'M': [20, 1, 32, 0, 0, ],
        'Q': [26, 1, 26, 0, 0, ],
...
# type bit that will place on type pattern position.
type_bits = {
    'L': {
        0: '111011111000100',
